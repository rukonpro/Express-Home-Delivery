...
const DeliverMan = () => {
    AOS.init();
    return (
        <div className=' container-fluid  mt-11 py-14 DeliveryMan-container'>
            <div className='container'>
                ...
                <div className='row p-4'>
                    ...
                    <div data-aos="fade-right" className='col-lg-4 col-md-6 col-sm-12'>
                        <img src="https://i.ibb.co/jWpRsyt/join1.png" alt="" />
                    </div>
                    <div className='col-lg-4 col-md-6 col-sm-12'>
                        <img data-aos="fade-left" src="https://i.ibb.co/xqGgW6j/story2-removebg-preview.png" alt="" />
                    </div>
                </div>
            </div>
